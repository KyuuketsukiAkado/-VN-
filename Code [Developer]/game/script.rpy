...
label no_investor_route:
    ...
    $ csay(Character("Телефон"), "{i}*Бззззз*{/i}")
    ...
    $ csay(Character("Телефон"), "{i}*Гудки вызова*{/i}")
    ...
    $ csay(Character("Телефон"), "{i}*Гудки*{/i}")
...
label talk_to_pasha:
    ...
    if not agreed_with_liza:
        call talk_to_pasha_no_investor
        hide pasha
        with dissolve
        return
